...
const Card = (props) => {
    return (
        <div className='bg-[url("./img/frame.svg")] lg:w-[23rem] lg:h-[15rem] h-[18rem] flex flex-col justify-center items-center bg-center bg-cover border border-[#38353d] rounded-2xl gap-4 text-center'>
            <div className='flex flex-col justify-center items-center gap-1 w-full radial-bg h-full px-6'>
                ...
                <p className='text-[#C1CFD8] text-sm'>{props.description}</p>
            </div>
        </div>
    );
}
